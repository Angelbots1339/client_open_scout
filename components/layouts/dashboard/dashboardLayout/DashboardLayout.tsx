                ...
                <Box sx={{ml: 10, mr: 10, mt: 5, width: "auto", height: "auto"}}>
                    <div className={styles.cardHeader}>
                        <Typography variant="h2"
                                    className={styles.breadcrumbsHeader}> {splitPath[splitPath.length - 1] === "dashboard" ? "Home" : splitPath[splitPath.length - 1].charAt(0).toUpperCase() + splitPath[splitPath.length - 1].slice(1)} </Typography>
                        ...
                        <Breadcrumbs aria-label="breadcrumb" className={styles.breadcrumbs}>
                            ...
                            {splitPath.map((dir: string) =>
                                <Link key={dir} underline="hover" color="inherit"
                                      href={dir === "home" || dir === "dashboard" ? "/dashboard" : "/dashboard/" + dir.toLowerCase()}>
                    ...
                    <Card color={"primary"}
                          sx={{width: "100%", height: "auto", boxShadow: 5, minWidth: 700, minHeight: 400}}>
                        {children}
                    </Card>
                </Box>
            </div>
