 ...
 */
const TableDraggable: React.FC<ITableDraggable> = ({data, headerName, keysToDisplay, displayNames, url}) => {

    const [rowsArray, setRowsArray] = useState(data);
...
const DragRow: React.FC<IDragRow> = ({rowData, row, index, keysToDisplay, url}) => {
